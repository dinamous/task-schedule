        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center space-x-4">
            <h1 class="text-2xl font-bold text-foreground">Task Schedule</h1>
               ...
               <router-link to="/create" class="text-muted-foreground hover:text-foreground transition-colors">
                 Nova Tarefa
               </router-link>
             </nav>
          </div>
        ...
        <div class="flex items-center justify-between mb-6">
          ...
          <button @click="closeSidebar" class="p-1 rounded-md hover:bg-accent">
            <X class="w-5 h-5" />
                 ...
                 <nav class="space-y-2">
           <router-link to="/" class="block px-3 py-2 rounded-md text-muted-foreground hover:text-foreground hover:bg-accent transition-colors">
             Início
           </router-link>
           <router-link to="/create" class="block px-3 py-2 rounded-md text-muted-foreground hover:text-foreground hover:bg-accent transition-colors">
             Nova Tarefa
           </router-link>
         </nav>
      </div>
